...
const EditProfile = ({ profile: { profile }, createProfile, history }) => {
  useEffect(() => {
    if (profile !== null) {
      const {
        company,
  ...
  const onSubmit = (e) => {
    e.preventDefault();
    createProfile(editProfileData, history, profile !== null && !edit);
  };
  ...
  return (
    <Fragment>
      ...
      <p className="lead">
        <i className="fas fa-user"></i> update your profile information if
        needed.
      </p>
      ...
      <form onSubmit={onSubmit} className="form">
        ...
        <div className="form-group">
          ...
          <small className="form-text">
            {" "}
            Please use comma separated valus (eg. HTML,CSS,JavaScript,PHP){" "}
          </small>
        </div>
